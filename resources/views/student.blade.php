    ...
    <div class="container-fluid mt-4 " id="create-form">
        <!-- <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTi1tTbu7uque8BXNFjAuzspHJtImObsSbhGg&usqp=CAU" class="card-img-top" alt="...">
                    <div class="card-body">
    ...
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTc2pg4qpSPhoiUhwap4S4aMhyuv-7KQ67sig&usqp=CAU" class="card-img-top" alt="...">
                    <div class="card-body">
